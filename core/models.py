...
class Video(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("core:video", kwargs={
            'slug': self.slug
        })
...
class Order(models.Model):
    ...
    payafter = models.CharField(max_length=220, null = True)
    ...
    def get_payafter(self):
        return self.payafter
...
class Payment(models.Model):
    ...
    payafterdelivery = models.BooleanField(default=False, null= True)
    def __str__(self):
        return self.user.username
